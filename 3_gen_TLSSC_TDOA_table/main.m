...
mic_array_origin= [0 0 0];    % in the room

% Search range
search_range.theta= 0:2:359;        % 水平degree
% search_range.phi= 1:1:90;           % 垂直degree
search_range.phi= 1:5:90;           % 垂直degree
% search_range.r= [800 1600 2300 2900 3400 3800];   % milli meter
search_range.r= [400:400:3200];   % milli meter

search_range.x= [-3000:150:3000];   % milli meter
search_range.y= [-3000:150:3000];   % milli meter
search_range.z= [0:300:3000];   % milli meter
